...
include_controls 'microsoft-windows-server-2016-stig-baseline' do
  ...
  control 'V-73259' do
    ...
    Remove or disable accounts that have not been used in the last 30 days."
  end
  control 'V-73265' do
    impact 0
  ...
  control 'V-73283' do
    ...
    If \"AccountExpirationDate\" has not been defined within 30 days for any
  ...
  control 'V-73309' do
    ...
    If \"LockoutDuration\" is not 0 in the file, this
    is a finding.
    ...
    \"Account lockout duration\" to \"0\" minutes.
    
    A value of \"0\" is requires an administrator to unlock the
    account."
  end
  control 'V-73313' do
  ...
  control 'V-73315' do
    title "Windows Server 2016 password history must be configured to 12
    ...
    default value is \"12\" for Windows domain systems. CMS has decided this is the
